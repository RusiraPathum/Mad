...
public class DbHandler extends SQLiteOpenHelper {
    ...
    private static final String TABLE_NAME_BOOKING = "booking_db";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String TABLE_CREATE_QUERY = "CREATE TABLE "+TABLE_NAME_BOOKING+" " +
                "("
    ...
    public void add_Booking(Booking booking){
        ...
        sqLiteDatabase.insert(TABLE_NAME_BOOKING, null,contentValues);
    ...
    public void delete_Booking(int id){
        ...
        sqLiteDatabase.delete(TABLE_NAME_BOOKING,"booking_id =?",new String[]{String.valueOf(id)});
        sqLiteDatabase.close();
    }
    ...
    public Booking getSingleBooking(int id){
        ...
        Cursor cursor = sqLiteDatabase.query(TABLE_NAME_BOOKING, new String[]{BOOKING_ID,BOOKING_NAME,BOOKING_CONTACT,BOOKING_AGE,
    ...
    public int update_Booking(Booking booking){
        ...
        int status = sqLiteDatabase.update(TABLE_NAME_BOOKING,contentValues,
                BOOKING_ID +" =?",
